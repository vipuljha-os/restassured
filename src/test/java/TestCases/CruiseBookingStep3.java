...
public class CruiseBookingStep3 {
    ...
    @Test
    public void CruiseBookingStep3() {
        // Request body
        String requestBody = "{\n" +
                "    \"fare_type\": \"retail\",\n" +
                "    \"live_data\": true,\n" +
    ...
    private void validateResponseBody(Response response) {
        ...
        if (sailingsAvailablityRoomPrice != null && !sailingsAvailablityRoomPrice.toString().isEmpty()) {
            ...
            assertThat("Field 'sailingsAvailablityRoomPrice' should have a valid value!",
                    sailingsAvailablityRoomPrice.toString().trim(), not(isEmptyOrNullString()));
        } else {
        ...
        if (sailingsavailablitysingleroompriceoffer != null && !sailingsavailablitysingleroompriceoffer.toString().isEmpty()) {
            ...
            assertThat("Field 'sailingsavailablitysingleroompriceoffer' should have a valid value!",
                    sailingsavailablitysingleroompriceoffer.toString().trim(), not(isEmptyOrNullString()));
        } else {
            // Value is null or empty
        ...
        if (sailingsavailablitytaxesperperson != null && !sailingsavailablitytaxesperperson.toString().isEmpty()) {
            ...
            assertThat("Field 'sailingsavailablitytaxesperperson' should have a valid value!",
                    sailingsavailablitytaxesperperson.toString().trim(), not(isEmptyOrNullString()));
        } else {
            // Value is null or empty
