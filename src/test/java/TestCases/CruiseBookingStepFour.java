...
public class CruiseBookingStepFour {
...
//    }
    ...
    @Test
    public void testCruiseBookingStepFour() {
        // Call the helper method to execute the API logic
        Object result = VerifyCruiseBookingStepFour();
    }

    public static JSONObject VerifyCruiseBookingStepFour() {
        try {
            CruiseBookingStep3 cruiseBookingStep3 = new CruiseBookingStep3();
            // Get the response of Step 3
            JSONObject response1 = (JSONObject) CruiseBookingStepThree.CruiseBookingStepThree();
            System.out.println("***********");
    ...
    private static void validateResponseBody1WayOnWard(JSONObject response) {
        ...
        if (wayOnwardSailingType != null && !wayOnwardSailingType.toString().isEmpty()) {
            // Value is not null or empty
            System.out.println("Field 'wayOnwardSailingType' has a valid value: " + wayOnwardSailingType);
