...
public class CruiseBookingStepSeven {
    ...
    public void testCruiseBookingStep7() {
        ...
        Object result = VerifyCruiseBookingStepSeven();
    }
    public Object VerifyCruiseBookingStepSeven() {
        CruiseBookingStepFive cruiseBookingStepFive = new CruiseBookingStepFive();
        // Get the response of Step 1 (assuming the response object is stored in CruiseBookingStep1.responseOfStep1)
        JSONObject response1 = cruiseBookingStepFive.VerifyCruiseBookingStepFive();
        System.out.println("***********");
