...
public class CruiseBookingStepSix {
...
//    }
    @Test
    public void testCruiseBookingStepSix() {
        // Call the helper method to execute the API logic
        Object result = VerifyCruiseBookingStepSix();
    }
    public static Object VerifyCruiseBookingStepSix() {
        CruiseBookingStepFive cruiseBookingStep5 = new CruiseBookingStepFive();
        // Get the response of Step 1 (assuming the response object is stored in CruiseBookingStep1.responseOfStep1)
        JSONObject response1 = cruiseBookingStep5.VerifyCruiseBookingStepFive();
        System.out.println("***********");
