...
public class GetCannedReponseZeptoTest extends ZeptoLogin {
    @Test
    public void GetCannedResponseZepto() {
        ...
        Response response = given()
                ...
                .when()
                .post(ZeptoRoutes.ZeptoCannedResponse);
        ...
        assertTrue(responseTime < 1000, "Response time exceeds the acceptable threshold of 1000 milliseconds");
