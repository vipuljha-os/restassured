...
public class GoldenRamaAssignToTicketTest extends GoldenRamaLogin {
    @Test
    public void assignToTicketGoldenRama() throws IOException{
        ...
        Response response = given()
                ...
                .formParam("assign_to","179446#GOLDEN RAMA")
                .formParam("task_detail","Test")
                .when()
                .post(GoldenRamaRoutes.assignToTicket);
        ...
        System.out.println("Ticket with ticketId => "+ticketId+" has been successfully assigned to Golden RAMA superadmin");
