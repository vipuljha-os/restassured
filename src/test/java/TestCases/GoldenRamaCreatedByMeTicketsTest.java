...
public class GoldenRamaCreatedByMeTicketsTest extends GoldenRamaLogin {
    @Test
    public  void getCreatedByMeTicketsGoldenRama(){
        ...
        System.out.println("-----------------------------------");
        System.out.println("Response Status => " + responseParamValidation);
    }
}
